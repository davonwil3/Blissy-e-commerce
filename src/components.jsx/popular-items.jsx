...
function Popular() {
  ...
  function handleCart(cartSrc, cartName, cartPrice, size) {
    ...
    if (typeof size !== "undefined") {
      ...
      setModal(
        <Cartm page="menu" close={handleClose} />
      );
    }
  }
    ...
    <div>
      ...
      <div className="flex-container" id="gender-sec">
        <div className="flex-container gender-containerM">
          ...
          <Link to={`/collection`} onClick={() => sendItem("Men")}>
            <ButtonUI variant="contained" color="secondary" className="gender-button">
              Shop
            </ButtonUI>
          </Link>
        </div>
        ...
        <div className="flex-container gender-containerW">
          ...
          <div className="gender-overlay"></div>
          <Link to={`/collection`} onClick={() => sendItem("Women")}>
            <ButtonUI variant="contained" color="secondary" className="gender-button">
              Shop
            </ButtonUI>
          </Link>
        ...
        <div className="flex-container " id="about-UsSec">
          <div className="flex-container about-us">
            ...
            <p className="about-text">
              Blissy delivers high quality clothes at bargain prices. We manufacture our own clothes so we can set great prices for our customers.
        ...
        <div className="flex-container" id="best-seller">
          ...
          <p className="store-title">Best Sellers</p>
          <div className="title-style"></div>
          <div className="break"></div>
        ...
        <div className="flex-container clothes">
          <div className="flex-container advertisement1">
            <Link to={`/collection`} className="Link" onClick={() => sendItem("dresses")}>
              <div className="flex-container ad-text">
                <p className="ad-title">Shop dresses</p>
              </div>
            </Link>
          </div>
          <div className="flex-container advertisement2">
            <Link to={`/collection`} className="Link" onClick={() => sendItem("pants")}>
              <div className="flex-container ad-text">
                <p className="ad-title">Shop jeans</p>
              </div>
            </Link>
          </div>
          <div className="flex-container advertisement3">
            <Link to={`/collection`} className="Link" onClick={() => sendItem("shirts")}>
              <div className="flex-container ad-text">
                <p className="ad-title">Shop shirts</p>
              </div>
            </Link>
          </div>
        </div>
