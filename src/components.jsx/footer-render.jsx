...
return(
  ...
  <div className="flex-container" id={display}>
    ...
    <div className="flex-container footer-brand">
      ...
      <p className="footer-text"><FontAwesomeIcon icon={faMapMarkerAlt} size="lg" className="footer-icon"/>  78 Baron Ave, WestBabylon, NY 11704 </p>
      <p className="footer-text"><FontAwesomeIcon icon={faEnvelope} size="lg"  className="footer-icon"/>  blissy@gmail.com</p>
      <p className="footer-text"><FontAwesomeIcon icon={faPhoneAlt} size="lg"  className="footer-icon"/> +631 504 9714</p>
      <p className="footer-text"><FontAwesomeIcon icon={faFacebookF} size="md"  className="social-icon"/><FontAwesomeIcon icon={faTwitter} size="md"  className="social-icon"/><FontAwesomeIcon icon={faInstagram} size="md" className="social-icon" /><FontAwesomeIcon icon={faPinterestP} size="md"  className="social-icon"/></p>
