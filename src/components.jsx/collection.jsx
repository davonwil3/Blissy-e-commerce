    ...
    <div>
      <div className="flex-container " id="collection">
        ...
        <div className="flex-container" id="collectionS">
          ...
          <div className="title-style"></div>  <p className="store-title">Our Collection</p> <div className="title-style"></div>
          <div className="break"></div>
          <p className="store-des M" onClick={() => handleStoreM()}>Men's</p>
          <p className="store-des W" onClick={() => handleStoreW()} >Women's</p>
          <div className="break"></div>

          {storeContent}

          <Box mt="1%" ml="auto" mr="auto" mb="" width="200px" height="35px" >
            <Link to={`/collection`}><ButtonUI variant="outlined" color="secondary" style={{ height: "100%", width: "100%", fontSize: "11px" }}  >
              Show More
            </ButtonUI> </Link>
          </Box>
