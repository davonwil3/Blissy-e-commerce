      ...
      <div className="flex-container cart-page">
        <div className="flex-container cart-main">
          ...
          <div className="flex-container table-container">
            ...
            <em className="table-text table-price">Price</em><em className="table-text table-quantity">quantity</em>
        ...
        <div className="flex-container subtotal-wrapper">
          <div className="flex-container cart-subtotal">
            ...
            <div className="flex-container shipping-container"><div className="shipping-text">Shipping</div>  <div className="shipping-price">Free</div></div>
            <div className="shipping-description">. Shipping is free and takes 10-12 days depending on your location if you have an issue with your purchase you can call our company and return your product. </div>

            <Box mt="5%" ml="auto" mr="auto" width="82%" >
              <Link ><ButtonUI variant="contained" color="secondary" style={{ width: "100%", fontSize: "11px" }}   >
                Checkout
              </ButtonUI></Link>
            </Box>
