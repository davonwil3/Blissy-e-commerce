      ...
      <Navbar className="nav-bg" variant="light" expand="lg">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto nav-padding">
            <Navbar.Brand className="nav-brand brand">
              <Link to={`/`} style={{ color: 'black' }}>
                <p className="nav-text">Blissy</p>
              </Link>
            </Navbar.Brand>
            <Nav.Link>
            ...
            <Nav.Link>
              <Link to={`/collection`} style={{ color: 'gray' }} onClick={() => setCollection("Women")}>
                <p className="nav-text">Women</p>
              </Link>
            </Nav.Link>
            <Nav.Link>
              <Link to={`/collection`} style={{ color: 'gray' }} onClick={() => setCollection("Men")}>
                <p className="nav-text">Men</p>
              </Link>
            </Nav.Link>
            <Nav.Link>
            ...
            <Nav.Link>
              <Link to={`/checkout`} style={{ color: 'gray' }}>
                <p className="nav-text">Checkout</p>
              </Link>
            </Nav.Link>
            <Nav.Link className="icon-margin">
